        ...
        <Container fluid="md" id="our-services" className="my-5">
            ...
            <Row>
                ...
                <Col md={6} xs={12} className="d-flex flex-column why-us-text justify-content-center my-5">
                    ...
                    <p>Sewa mobil di Padang bersama Binar Car Rental jaminan harga lebih murah dibandingkan yang lain, kondisi mobil baru, serta kualitas pelayanan terbaik untuk perjalanan wisata, bisnis, wedding, meeting, dll</p>

                    <div className="mt-3">
                        <div className="d-flex align-items-center mt-3">
                            <Image src={list_check} alt="list check" />
                            <p>Sewa Mobil Dengan Supir di Padang 12 Jam</p>
                        </div>

                        <div className="d-flex align-items-center mt-3">
                            <Image src={list_check} alt="list check" />
                            <p>Sewa Mobil Lepas Kunci di Padang 24 Jam</p>
                        </div>
